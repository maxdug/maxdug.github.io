...
<!-- M E N U -->
<div markdown="1" style="flex: 0 1 10%; min-width: 300px; margin:0; padding: 0; position: -webkit-sticky; position:sticky; align-self:flex-start; font-size: 14px;justify-self:flex-start; top:110px;">
...
<!-- C O N T E N T -->
<div style="flex: 0 1 10%; max-width: 720px;  margin: 20px; padding: 0;" markdown="1">
